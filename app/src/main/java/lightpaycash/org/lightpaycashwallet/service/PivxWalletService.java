package lightpaycash.org.lightpaycashwallet.service;
...
import org.lightpaycashj.core.listeners.AbstractPeerDataEventListener;
import org.lightpaycashj.core.listeners.PeerConnectedEventListener;
import org.lightpaycashj.core.listeners.PeerDataEventListener;
...
import lightpaycash.org.lightpaycashwallet.module.PivxModuleImp;
import lightpaycash.org.lightpaycashwallet.module.store.SnappyBlockchainStore;
import lightpaycash.org.lightpaycashwallet.rate.CoinMarketCapApiClient;
import lightpaycash.org.lightpaycashwallet.rate.RequestPivxRateException;
...
import static lightpaycash.org.lightpaycashwallet.module.PivxContext.CONTEXT;
import static lightpaycash.org.lightpaycashwallet.service.IntentsConstants.ACTION_ADDRESS_BALANCE_CHANGE;
import static lightpaycash.org.lightpaycashwallet.service.IntentsConstants.ACTION_BROADCAST_TRANSACTION;
import static lightpaycash.org.lightpaycashwallet.service.IntentsConstants.ACTION_CANCEL_COINS_RECEIVED;
import static lightpaycash.org.lightpaycashwallet.service.IntentsConstants.ACTION_NOTIFICATION;
import static lightpaycash.org.lightpaycashwallet.service.IntentsConstants.ACTION_RESET_BLOCKCHAIN;
import static lightpaycash.org.lightpaycashwallet.service.IntentsConstants.ACTION_SCHEDULE_SERVICE;
import static lightpaycash.org.lightpaycashwallet.service.IntentsConstants.DATA_TRANSACTION_HASH;
import static lightpaycash.org.lightpaycashwallet.service.IntentsConstants.INTENT_BROADCAST_DATA_BLOCKCHAIN_STATE;
import static lightpaycash.org.lightpaycashwallet.service.IntentsConstants.INTENT_BROADCAST_DATA_ON_COIN_RECEIVED;
import static lightpaycash.org.lightpaycashwallet.service.IntentsConstants.INTENT_BROADCAST_DATA_PEER_CONNECTED;
import static lightpaycash.org.lightpaycashwallet.service.IntentsConstants.INTENT_BROADCAST_DATA_TYPE;
import static lightpaycash.org.lightpaycashwallet.service.IntentsConstants.INTENT_EXTRA_BLOCKCHAIN_STATE;
import static lightpaycash.org.lightpaycashwallet.service.IntentsConstants.NOT_BLOCKCHAIN_ALERT;
import static lightpaycash.org.lightpaycashwallet.service.IntentsConstants.NOT_COINS_RECEIVED;
...
public class PivxWalletService extends Service{
    ...
    private class RunnableBlockChecker implements Runnable{
        ...
        @Override
        public void run() {
            org.lightpaycashj.core.Context.propagate(PivxContext.CONTEXT);
    ...
    private WalletCoinsReceivedEventListener coinReceiverListener = new WalletCoinsReceivedEventListener() {
        ...
        public void onCoinsReceived(Wallet wallet, Transaction transaction, Coin coin, Coin coin1) {
            ...
            org.lightpaycashj.core.Context.propagate(CONTEXT);
