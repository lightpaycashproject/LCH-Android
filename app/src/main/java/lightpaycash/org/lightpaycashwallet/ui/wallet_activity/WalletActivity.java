package lightpaycash.org.lightpaycashwallet.ui.wallet_activity;
...
import lightpaycash.org.lightpaycashwallet.ui.CustomTypefaceSpan;
import lightpaycash.org.lightpaycashwallet.ui.base.BaseDrawerActivity;
...
import lightpaycash.org.lightpaycashwallet.ui.qr_activity.QrActivity;
import lightpaycash.org.lightpaycashwallet.ui.settings_backup_activity.SettingsBackupActivity;
import lightpaycash.org.lightpaycashwallet.ui.transaction_request_activity.RequestActivity;
import lightpaycash.org.lightpaycashwallet.ui.transaction_send_activity.SendActivity;
import lightpaycash.org.lightpaycashwallet.ui.upgrade.UpgradeWalletActivity;
import lightpaycash.org.lightpaycashwallet.utils.AnimationUtils;
...
import static lightpaycash.org.lightpaycashwallet.ui.transaction_send_activity.SendActivity.INTENT_ADDRESS;
import static lightpaycash.org.lightpaycashwallet.ui.transaction_send_activity.SendActivity.INTENT_EXTRA_TOTAL_AMOUNT;
import static lightpaycash.org.lightpaycashwallet.ui.transaction_send_activity.SendActivity.INTENT_MEMO;
...
public class WalletActivity extends BaseDrawerActivity {
    ...
    private void updateBalance() {
        ...
        txt_value.setText(!availableBalance.isZero()?availableBalance.toFriendlyString():"0 COLX");
        Coin unnavailableBalance = pivxModule.getUnnavailableBalanceCoin();
        txt_unnavailable.setText(!unnavailableBalance.isZero()?unnavailableBalance.toFriendlyString():"0 COLX");
        if (pivxRate == null)
