package lightpaycash.org.lightpaycashwallet.ui.transaction_send_activity;
...
import lightpaycash.org.lightpaycashwallet.module.NoPeerConnectedException;
import lightpaycash.org.lightpaycashwallet.rate.db.PivxRate;
import lightpaycash.org.lightpaycashwallet.service.PivxWalletService;
import lightpaycash.org.lightpaycashwallet.ui.base.BaseActivity;
import lightpaycash.org.lightpaycashwallet.ui.base.dialogs.SimpleTextDialog;
import lightpaycash.org.lightpaycashwallet.ui.base.dialogs.SimpleTwoButtonsDialog;
import lightpaycash.org.lightpaycashwallet.ui.transaction_send_activity.custom.ChangeAddressActivity;
import lightpaycash.org.lightpaycashwallet.ui.transaction_send_activity.custom.CustomFeeActivity;
import lightpaycash.org.lightpaycashwallet.ui.transaction_send_activity.custom.CustomFeeFragment;
import lightpaycash.org.lightpaycashwallet.ui.transaction_send_activity.custom.inputs.InputWrapper;
import lightpaycash.org.lightpaycashwallet.ui.transaction_send_activity.custom.inputs.InputsActivity;
import lightpaycash.org.lightpaycashwallet.ui.transaction_send_activity.custom.outputs.OutputWrapper;
import lightpaycash.org.lightpaycashwallet.ui.transaction_send_activity.custom.outputs.OutputsActivity;
import lightpaycash.org.lightpaycashwallet.ui.wallet_activity.TransactionWrapper;
import lightpaycash.org.lightpaycashwallet.utils.CrashReporter;
...
import lightpaycash.org.lightpaycashwallet.utils.QrUtils;
import lightpaycash.org.lightpaycashwallet.utils.scanner.ScanActivity;
import wallet.exceptions.InsufficientInputsException;
import wallet.exceptions.TxNotFoundException;

import static android.Manifest.permission_group.CAMERA;
import static android.graphics.Color.WHITE;
import static lightpaycash.org.lightpaycashwallet.service.IntentsConstants.ACTION_BROADCAST_TRANSACTION;
import static lightpaycash.org.lightpaycashwallet.service.IntentsConstants.DATA_TRANSACTION_HASH;
import static lightpaycash.org.lightpaycashwallet.ui.qr_activity.MyAddressFragment.convertDpToPx;
import static lightpaycash.org.lightpaycashwallet.ui.transaction_detail_activity.FragmentTxDetail.TX;
import static lightpaycash.org.lightpaycashwallet.ui.transaction_detail_activity.FragmentTxDetail.TX_MEMO;
import static lightpaycash.org.lightpaycashwallet.ui.transaction_detail_activity.FragmentTxDetail.TX_WRAPPER;
import static lightpaycash.org.lightpaycashwallet.ui.transaction_send_activity.custom.ChangeAddressActivity.INTENT_EXTRA_CHANGE_ADDRESS;
import static lightpaycash.org.lightpaycashwallet.ui.transaction_send_activity.custom.ChangeAddressActivity.INTENT_EXTRA_CHANGE_SEND_ORIGIN;
import static lightpaycash.org.lightpaycashwallet.ui.transaction_send_activity.custom.CustomFeeFragment.INTENT_EXTRA_CLEAR;
import static lightpaycash.org.lightpaycashwallet.ui.transaction_send_activity.custom.CustomFeeFragment.INTENT_EXTRA_FEE;
import static lightpaycash.org.lightpaycashwallet.ui.transaction_send_activity.custom.CustomFeeFragment.INTENT_EXTRA_IS_FEE_PER_KB;
import static lightpaycash.org.lightpaycashwallet.ui.transaction_send_activity.custom.CustomFeeFragment.INTENT_EXTRA_IS_MINIMUM_FEE;
import static lightpaycash.org.lightpaycashwallet.ui.transaction_send_activity.custom.CustomFeeFragment.INTENT_EXTRA_IS_TOTAL_FEE;
import static lightpaycash.org.lightpaycashwallet.ui.transaction_send_activity.custom.inputs.InputsFragment.INTENT_EXTRA_UNSPENT_WRAPPERS;
import static lightpaycash.org.lightpaycashwallet.ui.transaction_send_activity.custom.outputs.OutputsActivity.INTENT_EXTRA_OUTPUTS_CLEAR;
import static lightpaycash.org.lightpaycashwallet.ui.transaction_send_activity.custom.outputs.OutputsActivity.INTENT_EXTRA_OUTPUTS_WRAPPERS;
import static lightpaycash.org.lightpaycashwallet.utils.QrUtils.encodeAsBitmap;
import static lightpaycash.org.lightpaycashwallet.utils.scanner.ScanActivity.INTENT_EXTRA_RESULT;
